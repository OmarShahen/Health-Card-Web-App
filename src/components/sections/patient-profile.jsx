...
const PatientProfileSection = ({ patient }) => {
    ...
    return <div>
        {/*<div className="patient-profile-information-container">
    <img src={`https://avatars.dicebear.com/api/initials/${patient.firstName + '' + patient.lastName}.svg`} alt="user image"/>
    <div>
        <strong className="subheader-text">{`${patient.firstName} ${patient.lastName}`}</strong>
        <span className="body-text bold-text blue">{`+${patient.countryCode}${patient.phone}`}</span>
    </div>
</div>*/}
