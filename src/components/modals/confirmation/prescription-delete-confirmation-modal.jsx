...
const PrescriptionDeleteConfirmationModal = ({ prescription, reload, setReload, setIsShowModal }) => {
    ...
    const deletePrescription = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/prescriptions/${prescription._id}`)
        .then(response => {
            setIsLoading(false)
...
export default PrescriptionDeleteConfirmationModal