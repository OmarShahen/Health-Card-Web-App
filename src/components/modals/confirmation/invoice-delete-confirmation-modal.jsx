...
const InvoiceDeleteConfirmationModal = ({ invoice, reload, setReload, setIsShowModal }) => {
    ...
    const deleteInvoice = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/invoices/${invoice._id}`)
        .then(response => {
            setIsLoading(false)
...
export default InvoiceDeleteConfirmationModal