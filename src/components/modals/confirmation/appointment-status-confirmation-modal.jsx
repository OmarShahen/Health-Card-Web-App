...
const AppointmentStatusConfirmationModal = ({ appointment, reload, setReload, setIsShowModal, setViewStatus, status }) => {
    ...
    const updateAppointmentStatus = () => {
        setIsLoading(true)
        serverRequest.patch(`/v1/appointments/${appointment._id}/status`, { status })
        .then(response => {
            setIsLoading(false)
    ...
    return <div className="modal">
        <div className="confirmation-modal-container body-text">
            ...
            <div className="body-text confirmation-modal-body">
                <p>
                    {translations[lang]["You're about to update this appointment status"]}
                </p>
                <p>
...
export default AppointmentStatusConfirmationModal