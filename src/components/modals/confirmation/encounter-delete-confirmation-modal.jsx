...
const EncounterDeleteConfirmationModal = ({ encounter, reload, setReload, setIsShowModal }) => {
    ...
    const deleteEncounter = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/encounters/${encounter._id}`)
        .then(response => {
            setIsLoading(false)
...
export default EncounterDeleteConfirmationModal