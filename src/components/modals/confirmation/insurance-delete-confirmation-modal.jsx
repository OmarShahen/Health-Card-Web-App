...
const InsuranceDeleteConfirmationModal = ({ insurance, reload, setReload, setIsShowModal }) => {
    ...
    const deleteInsurance = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/insurances/${insurance._id}`)
        .then(response => {
            setIsLoading(false)
...
export default InsuranceDeleteConfirmationModal