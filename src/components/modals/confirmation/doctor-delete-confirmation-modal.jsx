...
const DoctorDeleteConfirmationModal = ({ clinicDoctor, reload, setReload, setIsShowModal }) => {

    const lang = useSelector(state => state.lang.lang)

    const [isLoading, setIsLoading] = useState(false)

    const deleteClinicDoctor = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/clinics-doctors/${clinicDoctor._id}`)
        .then(response => {
            setIsLoading(false)
    ...
    return <div className="modal">
        <div className="confirmation-modal-container body-text">
            ...
            <div className="body-text confirmation-modal-body">
                <p>
                    { lang === 'en' ? "You're about to permanently delete this doctor from clinic" : null }
                </p>
                <p>
...
export default DoctorDeleteConfirmationModal