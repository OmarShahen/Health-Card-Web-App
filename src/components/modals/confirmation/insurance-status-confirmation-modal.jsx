...
const InsuranceStatusConfirmationModal = ({ insurance, reload, setReload, setIsShowModal, status }) => {

    const lang = useSelector(state => state.lang.lang)

    const [isLoading, setIsLoading] = useState(false)

    const updateInsuranceStatus = () => {
        setIsLoading(true)
        serverRequest.patch(`/v1/insurances/${insurance._id}/status`, { isActive: status })
        .then(response => {
            setIsLoading(false)
    ...
    return <div className="modal">
        <div className="confirmation-modal-container body-text">
            ...
            <div className="body-text confirmation-modal-body">
                <p>
                    {translations[lang]["You're about to update this insurance status"]}
                </p>
                <p>
...
export default InsuranceStatusConfirmationModal