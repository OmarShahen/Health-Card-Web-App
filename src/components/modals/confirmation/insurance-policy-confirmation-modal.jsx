...
const InsurancePolicyDeleteConfirmationModal = ({ insurancePolicy, reload, setReload, setIsShowModal, setViewStatus }) => {
    ...
    const deleteInsurancePolicy = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/insurance-policies/${insurancePolicy._id}`)
        .then(response => {
            setIsLoading(false)
...
export default InsurancePolicyDeleteConfirmationModal