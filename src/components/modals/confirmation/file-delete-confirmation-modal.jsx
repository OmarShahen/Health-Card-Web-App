...
const FileDeleteConfirmationModal = ({ file, reload, setReload, setIsShowModal }) => {
    ...
    const deleteFile = () => {
        setIsLoading(true)
        serverRequest.delete(`/v1/files/${file._id}`)
        .then(response => {
            setIsLoading(false)
...
export default FileDeleteConfirmationModal