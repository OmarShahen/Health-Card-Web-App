...
const InvoiceRefundConfirmationModal = ({ invoice, reload, setReload, setIsShowModal }) => {
    ...
    const refundInvoice = () => {
        setIsLoading(true)
        serverRequest.patch(`/v1/invoices/${invoice._id}/status`, { status: 'REFUNDED' })
        .then(response => {
            setIsLoading(false)
        ...
        <div className="confirmation-modal-container body-text">
             <div className="confirmation-modal-header">
                <h3>
                    ...
                    {translations[lang]['Refund']}
                </h3>
            </div>   
            <div className="body-text confirmation-modal-body">
                <p>
                {translations[lang]["You're about to refund this invoice"]}
                </p>
                <p>
            ...
            <div className="confirmation-modal-buttons-container">
                {
                    ...
                    >{translations[lang]['Refund']}</button>
                }
                <button 
...
export default InvoiceRefundConfirmationModal