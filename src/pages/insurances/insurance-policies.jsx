...
const InsurancePoliciesPage = ({ roles }) => {
    ...
    return <div className="page-container">
        <NavigationBar pageName={'Patients Insurance Policies'} />
        { 
        isShowDeleteModal ? 
        ...
        <div className="padded-container">
            <PageHeader 
            pageName={"Patients Insurance Policies"} 
            setShowModalForm={setShowFormModal} 
            addBtnText={user.roles.includes('STAFF') ? 'Add Insurance Policy' : null}
            setReload={setReload}
            reload={reload}
            /> 
