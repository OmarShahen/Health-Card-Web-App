...
const ClinicsDoctorsRequestsPage = ({ roles }) => {
    ...
    useEffect(() => {
        setIsLoading(true)
        serverRequest.get(`/v1/clinics-requests/owners/${user._id}/doctors`)
        .then(response => {
            setIsLoading(false)
    ...
    return <div className="page-container">
        <PageHeader 
        pageName={translations[lang]["Doctors Requests"]} 
        isHideBackButton={true} 
        setShowModalForm={setIsShowForm}
        addBtnText={translations[lang]['Invite Doctor']}
        />
        {
...
export default ClinicsDoctorsRequestsPage