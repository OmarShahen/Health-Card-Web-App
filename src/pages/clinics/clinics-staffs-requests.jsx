...
const ClinicsStaffsRequestsPage = ({ roles }) => {
    ...
    useEffect(() => {
        setIsLoading(true)
        serverRequest.get(`/v1/clinics-requests/owners/${user._id}/staffs`)
        .then(response => {
            setIsLoading(false)
    ...
    return <div className="page-container">
        <PageHeader 
        pageName={translations[lang]['Staffs Requests']} 
...
export default ClinicsStaffsRequestsPage